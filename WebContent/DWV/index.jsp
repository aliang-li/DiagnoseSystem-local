...
<script type="text/javascript"
	src="node_modules/magic-wand-js/js/magic-wand-min.js"></script>
<!-- Third party (viewer) -->
<script type="text/javascript"
...
<script type="text/javascript">
      ...
      var uploadServletUrl="http://localhost:8090/SH/LabelUploadServlet";
      ...
      <%String labelPath = (String) request.getSession().getAttribute("labelDcmFileName");
			...
			String[] res = {"http://localhost:8090/test1/" + user.getLoginname() + "/" + labelPath};
...
<body>
	...
	<div data-role="page" data-theme="b" id="main">
		...
		<div id="pageHeader" data-role="header" style="">
			...
			<a href="javascript:"
				...
				data-i18n="basics.back">back</a> <a href="#help_page"
	...
	<!-- /page help_page-->
	<div>
		<input type="text" style="display: none;" id="path" name="textie"
			value="<%=path%>">
	</div>
</body>
<script type="text/javascript">
$(function(){
    ...
    //根据浏览器宽高动态改变div的宽高
    $("#contentPanel").width(cliWidth-330);
